...
public class LongTermSurface extends BaseClass {
	...
	public void drpDwn() {
		...
		ParkingLot.selectByValue("Long-Surface");
	}
	...
	public void TC07() {
		...
		List<WebElement> price = dr.findElements(By.className("SubHead"));
		assertEquals("$ 20.00", price.get(1).getText());
	...
	public void TC08() {
		...
		List<WebElement> price = dr.findElements(By.className("SubHead"));
		assertEquals("$ 30.00", price.get(1).getText());
	...
	public void TC09() {
		...
		List<WebElement> price = dr.findElements(By.className("SubHead"));
		assertEquals("$ 280.00", price.get(1).getText());
	...
	public void TC10() {
		...
		List<WebElement> price = dr.findElements(By.className("SubHead"));
		assertEquals("$ 1,060.00", price.get(1).getText());
	...
	public void TC11() {
		...
		List<WebElement> price = dr.findElements(By.className("SubHead"));
		assertEquals("$ 3,130.00", price.get(1).getText());
	...
	public void TC12() {
		...
		List<WebElement> price = dr.findElements(By.className("SubHead"));
		assertEquals("$ 3,136.00", price.get(1).getText());
